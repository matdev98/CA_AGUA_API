...
using caAGUAAPI.Application.Profiles;
...
using caAGUAAPI.API.Extensions;
using Microsoft.OpenApi.Models;
using caAGUAAPI.Infraestructure;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Api Agua", Version = "v1" });
